package com.qiyu.util.exception;
...
public class ExceptionUtil extends RuntimeException {
	...
	public static void throwExceptionUtil(Exception e) throws Exception{
		if(e instanceof BizException){
			...
			throw new DAOException("300", "数据库读取失败或远程调用接口失败,请稍后再试");
		}
	}
	
	
	public static Object catchException( Object obj, String method , Map<String,Object> params ,String code, String message){
		try{
			Method serviceMethod = obj.getClass().getMethod(method, Map.class);
			
			 Object result = serviceMethod.invoke(obj, params);
			 return result;
		}catch (Exception e) {
			throw new DAOException(code, message);
		}
	}
